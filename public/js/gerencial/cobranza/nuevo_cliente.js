...
$(document).on('submit','[data-form="guardar-establecimiento"]',function (e) {
    ...
    html +='<tr key='+random+'>'
        ...
        html +='<td data-select="action">'
            html +='<button class="btn btn-warning editar-establecimiento" type="button" data-key="'+random+'"> Editar</button> <button class="btn btn-danger anular-establecimiento" type="button" data-key="'+random+'"> Anular</button>'
        html +='</td>'
    html +='</tr>'
    html +='';
...
$(document).on('submit','[data-form="guardar-contacto"]',function (e) {
    ...
    html +='<tr key='+random+'>'
        ...
        html +='<td data-select="action">'
            html +='<button class="btn btn-warning editar-contacto" type="button" data-key="'+random+'"> Editar</button> <button class="btn btn-danger anular-contacto" type="button" data-key="'+random+'"> Anular</button>'
        html +='</td>'
    html +='</tr>'
    html +='';
