        ...
        'columnDefs': [
            { 'aTargets': [0], 'sClass': 'invisible' },
            {
                'render': function (data, type, row) {
                    ...
                    (array_accesos.find(element => element === 115)?`<button type="button" class="guia btn btn-warning btn-flat boton" data-toggle="tooltip"
                    ...
                    if (permiso == '1') {
                        if (row['estado'] !== 7) {
                            return `<div style="display:flex;">
                                    ...
                                    (array_accesos.find(element => element === 120)?`<button type="button" class="imprimir btn btn-info btn-flat boton" data-toggle="tooltip"
                                    data-placement="bottom" title="Descargar formato de impresión" data-guia="${row['id_guia_ven']}">
                                    <i class="fas fa-print"></i></button>`:``)+
                                    (array_accesos.find(element => element === 121)?`<button type="button" class="btn btn-success btn-flat boton ver-adjuntos" title="Ver Adjuntos" data-id="${row['id_requerimiento']}">
                                    <i class="fas fa-file-archive"></i></button>`:``)+``}

                                    ${(row['id_guia_ven'] == null && row['id_transformacion'] !== null)
                                    || row['estado_od'] == 21 || row['estado_od'] == 1 ?
                                    ``+(array_accesos.find(element => element === 120)?`<button type="button" class="anular btn btn-danger btn-flat boton" data-toggle="tooltip"
                            ...
                            return ``+(array_accesos.find(element => element === 30)?`<button type="button" class="anulacion btn btn-default btn-flat boton" data-toggle="tooltip"
