            ...
            if ($request->aplica_cambios_valor == 'si'){
                ...
                foreach ($ingresa as $i) {
                    ...
                    ->insertGetId([
                        ...
                        'part_number_transformado'=>(isset($i->part_number_transformado) ? $i->part_number_transformado : ''),
                        'descripcion_transformado'=>(isset($i->descripcion_transformado) ? $i->descripcion_transformado : ''),
                        'comentario_transformado'=>(isset($i->comentario_transformado) ? $i->comentario_transformado : ''),
                        'cantidad_transformado'=>(isset($i->cantidad_transformado) ? $i->cantidad_transformado : 0),
                        'estado'=>1,
                        'fecha_registro'=>date('Y-m-d H:i:s')
                        ],
                        'id_od_detalle'
