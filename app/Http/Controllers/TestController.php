...
class TestController extends Controller
{
    public function testDescripcionAdicionalOrden()
    {
        ...
        foreach ($lista as $key) {
            ...
            // $nombre = htmlspecialchars_decode(strip_tags(trim(str_replace(['•'], '', htmlspecialchars_decode($key->descripcion_adicional)))));

            $nombre = strtoupper(trim($this->quitar_tildes(str_replace(['•'], '', htmlspecialchars_decode($key->descripcion_adicional)))));

            // $nombre = trim(str_replace('•', '', htmlspecialchars_decode($key->descripcion_adicional)));
