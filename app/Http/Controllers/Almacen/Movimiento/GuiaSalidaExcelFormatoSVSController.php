...
class GuiaSalidaExcelFormatoSVSController extends Controller
{
    public static function insertarSeccionGuia($spreadsheet,$data)
    {
        ...
        $sheet->setCellValue('B10', $guia->punto_llegada);
        $sheet->getStyle('B10')->getAlignment()->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_TOP);
        $sheet->mergeCells('B10:AB10');
