...
class RequerimientoPagoController extends Controller
{
    ...
    public function viewListaRequerimientoPago(){
        ...
        return view('tesoreria/requerimiento_pago/lista',compact('prioridades','empresas','grupos','periodos','monedas','unidadesMedida','divisiones','gruposUsuario'));
    ...
    function guardarRequerimientoPago(Request $request){
        ...
        try {
            ...
            $requerimientoPago->id_proyecto = $request->id_proyecto > 0 ? $request->id_proyecto : null;
