<div class="modal fade" tabindex="-1" role="dialog" id="modal-guia_ven_cambio">
    <div class="modal-dialog">
        <div class="modal-content" style="width:400px;">
            <form id="form-guia_ven_cambio">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="close"><span aria-hidden="true">&times;</span></button>
                    <h3 class="modal-title">Cambio de Serie-Número</h3>
                </div>
                ...
                <div class="modal-footer">
                    <input type="submit" id="submit_guia_ven_cambio" class="btn btn-success" value="Guardar"/>
                </div>
            </form>
        </div>
    </div>
