        ...
        <div class="modal-content">
            <form id="form-od_transformacion">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">Instrucciones de la Transformación</h3>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5>Descripción</h5>
                            <textarea name="descripcion" cols="65" rows="5"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <h5>Comentario</h5>
                            <textarea name="comentario" cols="65" rows="5"></textarea>
                        </div>
                    </div>
                </div>
