<div class="modal fade" tabindex="-1" role="dialog" id="modal-nueva-cuenta-bancaria-destinatario" style="overflow-y: scroll;">
    <div class="modal-dialog" style="width: 400px;">
        <div class="modal-content">
            <form id="form-nueva-cuenta-bancaria-destinatario" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <p class="form-control-static"><strong id="nombre_contexto">Destinatario:</strong> <span id="nombre_destinatario"></span></p>
                        </div>
    
                        <div class="col-md-12">
                            <input class="oculto" name="id_persona">
                            <input class="oculto" name="id_contribuyente">
                            <input class="oculto" name="id_tipo_destinatario">
                            <h5>Banco</h5>
