                    ...
                    <div class="container-filter" style="margin: 0 auto;">
                        ...
                        <fieldset class="group-table">
                            <div class="row">
                                <div class="col-md-4">
                                        <label>
                                            <input type="checkbox" name="chkTipoOrden" style="margin-right: 3px;"> Tipo orden
                                        </label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div style="display:flex;">
                                        <input type="date" class="form-control input-sm handleChangeUpdateValorFiltroOrdenesElaboradas" name="fechaRegistroDesde" readOnly>
                                        <input type="date" class="form-control input-sm handleChangeUpdateValorFiltroOrdenesElaboradas" name="fechaRegistroHasta" readOnly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
